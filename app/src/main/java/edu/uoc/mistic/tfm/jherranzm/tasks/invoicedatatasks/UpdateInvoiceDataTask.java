...
public class UpdateInvoiceDataTask extends AsyncTask<Void, Void, Void> {

    private static final String TAG = UpdateInvoiceDataTask.class.getSimpleName();

    private final WeakReference<Activity> mActivityRef;

    private final InvoiceData invoiceData;

    public UpdateInvoiceDataTask(Activity activity, InvoiceData data){
    ...
    protected Void doInBackground(Void... voids) {
        ...
        Log.i(TAG, String.format("Updated local invoice : %s", this.invoiceData.toString()));
